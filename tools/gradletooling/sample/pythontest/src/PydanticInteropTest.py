...
class SampleModelInteropTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        c_band = PhotometryFilter(
            id="filter-PhotometryFilter_1034", # TODO this should be autogenerated
            name="C-Band",
        ...
        l_band = PhotometryFilter(
            id="filter-PhotometryFilter_1035", # TODO this should be autogenerated
            name="L-Band",
            description="radio band",
            bandName="L-Band",
            dataValidityFrom=datetime(2020, 1, 1, tzinfo=timezone.utc),
        ...
        cls.model = SampleModel(photometricSystem=[cls.ps], sourceCatalogue=[cls.sc],refs=SampleRefs(catalog_SkyCoordinateFrame=[frame]))
    ...
    def test_xml_serialise(self):
        ...
        source_catalogue = _find_first(root, "catalog.inner.SourceCatalogue")
...
class JpatestModelInteropTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        refInSub = ReferredTo3(id="jpatest-ReferredTo3_1005", sval="ref in sub", ival=3)
        ...
        # NB no convenient subtype from supertype constructor like java!
        sub = Sub(dval=ADtype(
            basestr="base",
            dref=ref3,
            intatt="intatt",
            ...
            tval=DThing(p=Point(x=1.5, y=3.0), dt="thing"),
            subval="this is a subtype",
            slist=[AEtype(evalr= 1.3, evals="subevals", intatt="intatt_sub", basestr="basestre_sub", dref=refInSub)])


        cls.model = JpatestModel(
            refs=JpatestRefs(refbase=[ref3, ref1,  ref2, refInSub]),
            parent=[parent,sub],
        )
