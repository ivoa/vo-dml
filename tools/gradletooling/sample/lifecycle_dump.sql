...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.ATEST;    
INSERT INTO "PUBLIC"."ATEST" VALUES
(1, NULL, 1);              
...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.ATEST2;   
INSERT INTO "PUBLIC"."ATEST2" VALUES
(1, 1, 1);
...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.ATEST3;   
INSERT INTO "PUBLIC"."ATEST3" VALUES
(1, 1);   
...
-- 2 +/- SELECT COUNT(*) FROM PUBLIC.CONTAINED;
INSERT INTO "PUBLIC"."CONTAINED" VALUES
(1, 1, 1, 1, 'firstcontained'),
(1, 1, 2, 2, 'secondContained');       
...
-- 2 +/- SELECT COUNT(*) FROM PUBLIC.REFERREDLIFECYCLE;        
INSERT INTO "PUBLIC"."REFERREDLIFECYCLE" VALUES
(1, 1, 'rc1'),
(1, 2, 'rc2');  
...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.REFERREDTO;               
INSERT INTO "PUBLIC"."REFERREDTO" VALUES
(3, 1);               
