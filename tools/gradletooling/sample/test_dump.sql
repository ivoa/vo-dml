...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.ASTROOBJECT;              
INSERT INTO "PUBLIC"."ASTROOBJECT" VALUES
...
-- 2 +/- SELECT COUNT(*) FROM PUBLIC.LUMINOSITYMEASUREMENT;    
INSERT INTO "PUBLIC"."LUMINOSITYMEASUREMENT" VALUES
...
-- 2 +/- SELECT COUNT(*) FROM PUBLIC.PHOTOMETRYFILTER;         
INSERT INTO "PUBLIC"."PHOTOMETRYFILTER" VALUES
(5.0, 1, NULL, TIMESTAMP '2024-10-29 13:17:54.67', TIMESTAMP '2024-10-29 13:17:54.67', 'C-Band', 'radio band', NULL, 'C-Band', 'GHz'),
(1.5, 2, NULL, TIMESTAMP '2024-10-29 13:17:54.67', TIMESTAMP '2024-10-29 13:17:54.67', 'L-Band', 'radio band', NULL, 'L-Band', 'GHz');   
...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.SKYCOORDINATEFRAME;       
INSERT INTO "PUBLIC"."SKYCOORDINATEFRAME" VALUES
...
-- 1 +/- SELECT COUNT(*) FROM PUBLIC.SOURCECATALOGUE;          
INSERT INTO "PUBLIC"."SOURCECATALOGUE" VALUES
(1, NULL, NULL, 'testCat');      
