<!-- This style sheet transforms a UML model, expressed in XMI, into the basic  
     ...
     XSLT is tested to work on XMI generated with
       o  Modelio v3.7 exporting UML 2.4.1
...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
  ...
  <xsl:variable name="uml_namespace" select="'http://www.omg.org/spec/UML/20110701'" />
  ...
  <!-- ============================================================
       Template: findRootId
         Migrated from 'common'.. find the root base class
       ============================================================ -->
